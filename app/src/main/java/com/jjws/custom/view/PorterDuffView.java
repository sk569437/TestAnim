...
public class PorterDuffView extends ImageView {
    ...
    public static final int FOREGROUND_COLOR = 0x99a0a0a0;
    /** 下载进度条的颜色。 */
    ...
    private int mForgroundColor = FOREGROUND_COLOR;
    private int mProgressTextColor = TEXT_COLOR;
    private int mProgressTextSize = FONT_SIZE;
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mForgroundColor = typedArr.getColor(R.styleable.porterduff_PorterDuffView_porterduffColor, FOREGROUND_COLOR);
            mProgressTextColor = typedArr.getColor(R.styleable.porterduff_PorterDuffView_porterduffTextColor, TEXT_COLOR);
            mProgressTextSize = typedArr.getDimensionPixelSize(R.styleable.porterduff_PorterDuffView_porterduffTextSize, FONT_SIZE);
